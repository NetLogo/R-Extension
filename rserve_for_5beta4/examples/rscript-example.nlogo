...
168
path
C:\\\\Programme\\\\NetLogo 5.0beta3\\\\extensions\\\\rserve\\\\examples\\\\rfunction1.r
1
0
String
...
245
75
Note, that the path belongs to the Rserve server. If you use a remote server, the file has to be on that machine. Furthermore, Rserve must be configured to allow file operations. 
11
0.0
1
