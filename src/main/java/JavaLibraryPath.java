 ...
 *
 * <p>The Terms of Use for the website, in the "Content Submitted to Sun" section states: You (the
 ...
 *
 * <p>http://www.sun.com/termsofuse.jsp
 *
 * <p>The username of the original post has no name or email associated with it.
 *
 * <p>Adds a path to the java.library.path System property and updates the ClassLoader. Uses
 * reflection to allow update to private system members. Will not work if JVM security policy gets
 * in the way (like in an applet). Will not work if Sun changes the private members. This really
