;; Boxplot example of Rserve-extension
;;
;;
;; by Jan C. Thiele
...
to test2
  ...
  ; send the list into a new R dataframe (with one column named v1)
  (rserve:putdataframe "df1" "v1" mylist1 "v2" mylist2)
...
430
42
this initializes a connection to Rserve via port 6311 on \"localhost\". To start the Rserve server is up to you!
11
0.0
1
