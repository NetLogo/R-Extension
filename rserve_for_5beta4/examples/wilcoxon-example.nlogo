...
to setup
  ...
  [ 
    ...
    set change_rate 0.1 
    set fitness rserve:get "rweibull(1,1)" * 0.8
  ]
  ...
  [ 
    ...
    set fitness rserve:get "rweibull(1,1)" * 0.2
  ]
end
...
to go
  ...
  rserve:putagent "lowland" lowland_bugs "fitness"
  rserve:putagent "highland" highland_bugs "fitness"
  
  rserve:eval "w <- wilcox.test(lowland$fitness, highland$fitness, exact=FALSE)" 
  print rserve:get "w$p.value"
  
  set-current-plot "Wilcoxon Rank Sum Test"
  plot rserve:get "w$p.value"
