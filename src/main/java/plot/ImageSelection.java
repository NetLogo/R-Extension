...
/**
 * Class ImageSelection Used for the clipboard copy event of the JavaGD plot window.
 *
 * @version 1.0beta
 */
public class ImageSelection implements Transferable {
  ...
  public static ImageSelection copyComponent(
      Component paramComponent, boolean paramBoolean1, boolean paramBoolean2) {
