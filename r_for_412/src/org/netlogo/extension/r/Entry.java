...
public class Entry extends org.nlogo.api.DefaultClassManager 
{
	...
	public static class interactiveShell extends DefaultCommand
	{
	    ...
	    { 
	    	try
	    	{
	    		...
	    		// With reflection it is possible to check for the method and throw an exception if it isn't available, i.e. no console is available.
   ...
   * @since new in Version 0.3
	...
	/**
	 * Class to set Debug of JRI. (Implementation of the primitve startJRIDebug) 
   * @since new in Version 0.3
	 */	
	...
	/**
	 * Class to stop Debug of JRI. (Implementation of the primitve stopJRIDebug) 
   * @since new in Version 0.3
	 */		
	...
	/**
	 * Class to create a new Vector from Agent-Variables. (Implementation of the primitve putAgent) 
	 */	
	...
	/**
	 * Class to create a new R-Vector from NetLogo-Values. (Implementation of the primitve putList) 
	 */	
	...
	/**
	 * Class to create a new named R-Vector from NetLogo-Values. (Implementation of the primitve putNamedList) 
	 */	
	...
	/**
	 * Class to create a new R-Variable/Array from NetLogo-Values. (Implementation of the primitve put) 
	 */
	...
	/**
	 * Class to clear R workspace. (Implementation of the primitve clear) 
	 */	  
	...
	/**
	 * Class to save R history into file. (Implementation of the primitve saveHistory) 
	 * Currently not supported!
	 */	 	
