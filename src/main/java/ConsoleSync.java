...
/** Class ConsoleSync Notifys when commands are in the queue and send them. */
public class ConsoleSync {
  ...
  /**
   * this internal method waits until {@link #triggerNotification} is called by another thread. It
   * is implemented by using {@link wait()} and checking {@link notificationArrived}.
   */
  ...
  /**
   * this methods awakens {@link #waitForNotification}. It is implemented by setting {@link
   * #notificationArrived} to <code>true</code>, setting {@link #lastNotificationMessage} to the
   * passed message and finally calling {@link notifyAll()}.
   */
